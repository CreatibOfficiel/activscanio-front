    ...
    <div className={className}>
      <div className="flex justify-end items-center mb-4">
        <div className="text-sm text-neutral-400">
          Moyenne: <span className="font-semibold text-primary-400">{avgWinRate.toFixed(1)}%</span>
        </div>
      </div>
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={chartData}>
          ...
          <YAxis
            ...
            style={{ fontSize: '12px' }}
            domain={[0, 100]}
            label={{ value: '%', angle: -90, position: 'insideLeft', fill: '#a3a3a3' }}
          />
          <Tooltip
            contentStyle={{
          ...
          <ReferenceLine
            ...
            stroke="#737373"
            strokeDasharray="5 5"
            label={{ value: 'Moyenne', position: 'right', fill: '#737373' }}
          />
          <Line
            type="monotone"
            dataKey="winRate"
